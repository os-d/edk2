  ...
  )
{
  ...
  UT_ASSERT_TRUE (((MEMORY_PROTECTION_SETTINGS *)GET_GUID_HOB_DATA (Ptr))->Dxe.StructVersion == DXE_MEMORY_PROTECTION_SETTINGS_CURRENT_VERSION);
  UT_ASSERT_TRUE (((MEMORY_PROTECTION_SETTINGS *)GET_GUID_HOB_DATA (Ptr))->Dxe.CpuStackGuardEnabled);
