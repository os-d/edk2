  ...
  )
{
  ...
  //
  return gDS->AddMemorySpaceV2 (                // [CODE_FIRST] XXXX
                EfiGcdMemoryTypeMemoryMappedIo, // [CODE_FIRST] XXXX
                FLASH_CODE_BASE,                // [CODE_FIRST] XXXX
                SIZE_32MB,                      // [CODE_FIRST] XXXX
                EFI_MEMORY_UC,                  // [CODE_FIRST] XXXX
                EFI_MEMORY_UC                   // [CODE_FIRST] XXXX
                );                              // [CODE_FIRST] XXXX
}
