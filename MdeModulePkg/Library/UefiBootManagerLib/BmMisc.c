  ...
  )
{
  ...
  for (Index = 0; PreviousMemoryTypeInformation[Index].Type != EfiMaxMemoryType; Index++) {
    for (Index1 = 0; CurrentMemoryTypeInformation->Statistics[Index1].InformationIndex < EfiMaxMemoryType; Index1++) {
      if (CurrentMemoryTypeInformation->Statistics[Index1].InformationIndex == Index) {
        break;
      }
    }

    if (CurrentMemoryTypeInformation->Statistics[Index1].InformationIndex >= EfiMaxMemoryType) {
      continue;
    }
